...
----------
 ...
 -  摘要必須僅根據所提供原文中明確陳述的資訊。不得基於您對該主題的背景知識添加
    事實、解釋或結論。
 -  若作者的主張、結論或方法與普遍認知有所不同，請忠實反映作者的實際觀點。
    不要「修正」或規範化作者所寫的內容。
 -  不要填補作者論述中的空白，也不要添加您認為已隱含的資訊。僅摘要原文中實際
    存在的內容。
...
------------
 ...
 -  專業術語首次出現時，可以中文表示後在括號內附上原文（如：依賴注入（dependency
    injection））。
 -  使用符合中文語法規則的標點符號和間距。
