...
--------------
 ...
 -  要約は、提供された原文に明示的に記述されている情報のみに基づかなければなりません。
    そのトピックに関するあなたの背景知識をもとに、事実、説明、結論を追加しないでください。
 -  著者の主張、結論、アプローチが一般的に受け入れられているものと異なる場合でも、
    著者が実際に書いた視点を忠実に反映してください。著者が書いた内容を「修正」したり
    一般化したりしないでください。
 -  著者の論述の空白を埋めたり、含意されていると思われる情報を追加したりしないでください。
    原文に実際に存在する内容のみを要約してください。
...
----------------
 ...
 -  専門用語が初めて登場する際は、日本語表記の後に括弧内で原語を併記することができます（例：依存性注入（dependency
    injection））。
