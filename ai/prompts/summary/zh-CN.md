...
----------
 ...
 -  摘要必须仅基于所提供原文中明确陈述的信息。不得基于您对该主题的背景知识添加
    事实、解释或结论。
 -  如果作者的主张、结论或方法与普遍认知有所不同，请忠实反映作者的实际观点。
    不要“纠正”或规范化作者所写的内容。
 -  不要填补作者论述中的空白，也不要添加您认为已隐含的信息。仅摘要原文中实际
    存在的内容。
...
------------
 ...
 -  专业术语首次出现时，可以中文表示后在括号内附上原文（如：依赖注入（dependency
    injection）。）。
 -  使用符合中文语法规则的标点符号和间距。
